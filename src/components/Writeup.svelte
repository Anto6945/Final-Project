<main>
    <p> We have created a scroller that includes 3 of our planned visualizations. 
        We have created the separate files in Svelte and linked them all to the main App.Svelte file.
        So far, we have cleaned our data by changing the number of arrivals to millions and our bar graph has a slider
        that enables a user to pick the year. We've done the basic structure of our project with very simple 
        text and graphs. </p>
